  ...
  render() {    
    ...
    return (
      ...
      <View style={navBar.topBar}>
        ...
        <View style = {subHead.bar} >
        <TouchableOpacity style = {[subHead.menu, {borderBottomWidth:this.state._borderT1}]} 
            onPress= {this.__tChange1.bind()}>
              <Text >PENDING</Text> 
            </TouchableOpacity>
            <TouchableOpacity style = {[subHead.menu, {borderBottomWidth:this.state._borderT2}]}
            onPress= {this.__tChange2.bind()}>
              <Text >EXECUTED</Text> 
            </TouchableOpacity>
        </View>
        ...
        <View style = {{alignSelf:'center', alignItems:'center', justifyContent:'center', flex:1}}>
            <FontAwesome5 name="book-open" size={100}/>
            <Text> NO ORDERS </Text>
